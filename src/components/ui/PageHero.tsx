...
export function PageHero({
  ...
  return (
    <section className="border-b border-brand-line bg-brand-navy-950 py-14 sm:py-24">
      <Container>
        <div className="flex max-w-3xl flex-col gap-3.5 sm:gap-4">
          ...
          {description ? <p className="text-base leading-7 text-white/70 sm:text-lg sm:leading-8">{description}</p> : null}
        </div>
      </Container>
    </section>
  );
